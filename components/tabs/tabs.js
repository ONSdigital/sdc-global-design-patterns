...
// From: https://github.com/alphagov/govuk-frontend/blob/master/src/components/tabs/tabs.js
...
function Tabs ($module) {
  this.$module = $module
  this.$tabs = $module.querySelectorAll('.tab')
...
Tabs.prototype.getCurrentTab = function () {
  return this.$module.querySelector('.tabs__tab--selected')
}
