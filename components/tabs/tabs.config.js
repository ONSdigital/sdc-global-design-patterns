module.exports = {
  ...
  context: {
    ...
    },
    {
      'tab': 'QBS',
      'tabContent' : `<h3>Aim of this survey</h3>
        <p class="mars">The Quarterly Business Survey (QBS) collects quarterly information on employment of businesses in Great Britain. Your response contributes to Labour Market Statistics.</p>
        <h4>What you need to know</h4>
        <p class="mars">To complete the survey, you will need the following information to answer the survey questions:</p>
        <ul>
