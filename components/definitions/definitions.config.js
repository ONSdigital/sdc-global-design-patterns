module.exports = {
  ...
  context: {
    definitioncontent:
      'Do you connect an <a id="def-accumulator" href="#definition__accumulator" title="Definition of accumulator" class="definition__anchor" data-dialog-call="I really do not like you pressing that">accumulator</a> to your <a id="def-photovoltaic" href="#definition__photovoltaic" title="Definition of photovoltaic system" class="definition__anchor" data-dialog-call="Yo">photovoltaic system</a> to store surplus energy?',
    definitions: [
      {
